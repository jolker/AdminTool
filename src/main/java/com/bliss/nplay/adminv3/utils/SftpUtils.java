...
public class SftpUtils {
	...
	private void initChannelSftp() {
		...
		session = null;
		try {
			userName = Config.getParam("upload_server", "user");
			passWord = Config.getParam("upload_server", "password");
			hostName = Config.getParam("upload_server", "host");
			hostPort = Config.getParam("upload_server", "port");
			destinationDir = Config.getParam("upload_server", "destination_dir");
			JSch jsch = new JSch();
